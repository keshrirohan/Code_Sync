...
export default function RepoSection({ config, onUpdate }) {
  ...
  async function handleSave() {
    ...
    setSaving(true);
    try {
      await fetch(apiUrl("/api/repos/select"), {
        method: "POST",
      ...
      <div className="page">
        <div className="page-header">
          ...
          <p className="page-subtitle">
            Select the GitHub repository to push your submissions into.
          </p>
        </div>
        <div className="alert warn">
          <span className="alert-icon">⚠️</span>
          <span>
            Connect your GitHub account first to see your repositories.
          </span>
        </div>
      </div>
    );
      ...
      {config?.targetRepoUrl && (
        <div className="alert success mb-24">
          ...
          <span>
            ...
            <strong>{config.targetRepoName || config.targetRepoUrl}</strong>
          </span>
        </div>
      )}
              ...
              return (
                ...
                >
                  ...
                  <div className="repo-tags">
                    <span
                      className={`tag ${repo.private ? "tag-private" : "tag-public"}`}
                    >
        ...
        {!loading && filtered.length > 0 && (
          ...
          >
            <button
              ...
              onClick={handleSave}
              disabled={
                saving || !selected || selected === config?.targetRepoUrl
              }
            >
